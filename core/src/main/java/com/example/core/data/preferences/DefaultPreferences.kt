...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        val activityLvlString = sharedPreferences.getString(Preferences.KEY_ACTIVITY_LEVEL, null)
        ...
        return UserInfo(
            ...
            fatRatio = fatRatio,
            activityLevel = ActivityLevel.fromString(activityLvlString ?: "medium"),
            goalType = GoalType.fromString(goalTypeString ?: "keep_weight")
        )
    }

    override fun saveShouldOnboarding(shouldShow: Boolean) {
        sharedPreferences.edit().putBoolean(Preferences.KEY_SHOULD_ONBOARDING, shouldShow)
            .apply()
    }

    override fun loadShouldShowOnboarding(): Boolean {
        return sharedPreferences.getBoolean(
            Preferences.KEY_SHOULD_ONBOARDING,
            true
        )
    }
}